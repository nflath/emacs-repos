...
;;When I'm on windows, I want to use *eshell* instead of the built-in shell.
;;However, a few of my functions call shell directly, so I alias *shell* to
;;*eshell* if I'm using windows
