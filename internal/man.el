;;I usually try to do M-x man-mail, or whatever command I'm trying, before going to M-x max and entering the command.
;;The following actually installs all of the commands you can man as interactive command.
