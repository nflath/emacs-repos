;;;; `member-functions.el'
;;;; Copyright (c) 1998,1999,2000 Ron Lawrence <ral@bit-net.com>

;;;; This is version 0.3.1 License: GPL
...
implementation file."
  ...
  (save-window-excursion
    (save-excursion
      (save-restriction
        (let ((header (find-file-noselect header))
               (c-file (find-file-noselect c-file)))
        (set-buffer c-file)
        (goto-char (point-max))
